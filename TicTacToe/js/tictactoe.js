...
function placeXorO(squareNumber) {
    //This condition ensures a square hasn't been selected already. The .some() method is used to check each element of
    //selectedSquares array to see if it contains the square number clicked on.
    if (!selectedSquares.some(element=>element.includes(squareNumber))) {
        ...
        //squareNumber and activePlayer are concatendated together and added to array.
        ...
        function computersTurn(){
            ...
            let pickASquare;
            //This condition allows our while loop to keep trying if a square is selected alreadu.
            while (!success){
...
function animateLineDrawing() {
    ...
    c.strokeStyle = 'rgba(35,128,17,.8)';
    ...
    if (x1<=x2 && y1 <=y2) {
        ...
        if (y < y2) {y += 10;}
        //This condtion cances our animation loop if we've reached the end points.
